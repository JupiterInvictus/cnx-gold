...
function show_module() {
	...
	<thead>
		...
		<th class='dashboard-team-name'>
			...
			<span class='dashboard-team-surveys xtoggle' title='Surveys received'>$dksurveys</span>
			<span class='dashboard-team-latestsurvey xtoggle'>".getlatest($team_id_def[5])."</span>
		</th>

		<th class='dashboard-team-name'>
			<a href='?a=team&b=7'>NL</a>
			<span class='dashboard-team-surveys xtoggle' title='Surveys received'>$nlsurveys</span>
			<span class='dashboard-team-latestsurvey xtoggle'>".getlatest($team_id_def[7])."</span>
		</th>

		<th class='dashboard-team-name'>
			<a href='?a=team&b=6'>NO</a>
			<span class='dashboard-team-surveys xtoggle' title='Surveys received'>$nosurveys</span>
			<span class='dashboard-team-latestsurvey xtoggle'>".getlatest($team_id_def[6])."</span>
		</th>

		<th class='dashboard-team-name'>
			<a href='?a=team&b=4'>SE</a>
			<span class='dashboard-team-surveys xtoggle' title='Surveys received'>$sesurveys</span>
			<span class='dashboard-team-latestsurvey xtoggle'>".getlatest($team_id_def[4])."</span>
		</th>
	</thead>
	<tr><td></td><td colspan=11 class='big-title'>Core Metrics</td></tr>
...
/*
	echo "<tr>";
		echo "<td class='dashboard-metric-name'>CrRR</td>";
		echo displaydashboardbox(5,3);
		echo displaydashboardbox(7,3);
		echo displaydashboardbox(6,3);
		echo displaydashboardbox(4,3);
		echo "<td class='dashboard-metric-name-2'>CrRR</td>";
	echo "</tr>";

	echo "<tr>";
		echo "<td class='dashboard-metric-name'>FCR</td>";
		echo displaydashboardbox(5,16);
		echo displaydashboardbox(7,16);
		echo displaydashboardbox(6,16);
		echo displaydashboardbox(4,16);
		echo "<td class='dashboard-metric-name-2'>FCR</td>";
	echo "</tr>";
*/
	...
	echo "<tr>";
	echo "<td class='dashboard-metric-name'><u>Combined</u></td>";
