...
function show_module() {
	global $db, $_GET, $a, $b, $c, $d, $e, $f, $team, $sqldater, $ahtteamdefinition, $teamdefinition, $contract, $startdate, $enddate, $startdate_month, $startdate_year, $enddate_month, $enddate_year, $enddate_day, $startdate_day, $month, $monthy;
...
echo "</select>";
			if (($c2!='') && ($m2!='')){
				echo "<table class='tabler sortable' width=95%>";
				echo "<thead>";
				echo "<tr><th>$c2</th>";
